...
<body>
    <!-- Hero Section Begin -->
    <section class="hero spad set-bg" data-setbg="source/img/hero-bg2.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                <div class="consultation__form">
                        <div class="section-title">
                            ...
                            <h2>Klinik Thong Fhang</h2>
                        </div>
                            <a href="formKonsultasi.php" class="site-btn">Mulai Konsultasi</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="chooseus__item">
                        <img src="source/img/icons/ci-1.png" alt="">
                        <h5>Peralatan Estetika Modern</h5>
                        <p>Klinik Thong Fhang menggunakan peralatan-peralatan estetika medis yang canggih dan modern.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="chooseus__item">
                        <img src="source/img/icons/ci-2.png" alt="">
                        <h5>Dokter Spesialis Terpercaya</h5>
                        <p>Klinik Thong Fhang merupakan klinik Tuhan </p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="chooseus__item">
                        <img src="source/img/icons/ci-3.png" alt="">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="chooseus__item">
                        <img src="source/img/icons/ci-4.png" alt="">
                        <h5>Penanganan Terbaik</h5>
                        <p>Lorem ipsum amet, consectetur adipiscing elit, sed do eiusmod tempor cididunt facilisis.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-6 order-lg-1">
                        <div class="doctor__item__pic">
                            <img src="admin\source\img\AvatarDokter.jpg" alt="Avatar Doctor">
                        </div>
                    </div>
